/* V18.5 — push-only service worker. No UI caching: readers always get the current site. */
...
self.addEventListener('push',event=>{
  ...
  const options={body:data.body||'مادة جديدة نُشرت الآن.',icon:data.icon||'./assets/brand/icon-192.png?v=18.5',badge:data.badge||'./assets/brand/favicon.png?v=18.5',tag:data.tag||'dana-new-story',renotify:true,data:{url:data.url||'./'}};
